...
unsigned long buttonHoldTime = 0;         // the last time the output pin was toggled
unsigned long buttonHoldDelay = 2500;      // how long to hold the button down
